...
const TopBrands = () => {
    return (
        <div className='top-brands max-width'>
            <div className='collection-title'>These are the top brands</div>
            <Slider {...settings}>
                {topBrandsList.map(
                    (brand) => {
                        return (
                            <div key={brand.id}>
                                <div className='top-brands-cover cursor-point'>
                                    <img src={brand.cover} alt={brand.id} className='top-brands-image absolute-center'/>
                                    <div className='brands-time absolute-center'>{brand.time}</div>
                                </div>
                            </div>
                        )
                    }
